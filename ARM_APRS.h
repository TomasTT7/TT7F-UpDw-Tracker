...
extern uint8_t APRSpacket[330]; // max APRS packet size + flags (Destination 7, Source 7, Digipeater 0-56, Control 1, Protocol ID 1, Information 1-256, FCS 2)
extern uint8_t APRS_packet_mode;
extern uint8_t APRS_send_path; // 0 - don't send, 1 - send WIDE2-1
extern uint8_t APRS_show_alt_B91; // 0 - don't show, 1 - show
...
void APRS_telemetry_PARM(uint8_t *buffer, char *string, char *addressee); // addressee must have 9 characters (fill rest with 'space') "OK7DMT-0 "
void APRS_telemetry_UNIT(uint8_t *buffer, char *string, char *addressee); // addressee must have 9 characters (fill rest with 'space') "OK7DMT-0 "
void APRS_telemetry_EQNS(uint8_t *buffer, char *string, char *addressee); // addressee must have 9 characters (fill rest with 'space') "OK7DMT-0 "
void APRS_telemetry_BITS(uint8_t *buffer, char *string, char *addressee); // addressee must have 9 characters (fill rest with 'space') "OK7DMT-0 "
